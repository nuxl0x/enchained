...
class AgreementItem(settings: Settings) : Item(settings) {
    ...
    override fun use(world: World, user: PlayerEntity, hand: Hand): TypedActionResult<ItemStack> {
        ...
        val signedAgreement: ItemStack = BindingItems.SIGNED_AGREEMENT.defaultStack
        signedAgreement.nbt = nbt
        ...
        user.setStackInHand(hand, signedAgreement)
    ...
    override fun appendTooltip(stack: ItemStack, world: World?, tooltip: MutableList<Text>, context: TooltipContext) {
        ...
        tooltip.add(Text.translatable("itemTooltip.enchained.agreement1"))
        tooltip.add(Text.translatable("itemTooltip.enchained.agreement2"))
        tooltip.add(Text.translatable("itemTooltip.enchained.agreement3"))
