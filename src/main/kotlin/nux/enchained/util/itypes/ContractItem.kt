...
class ContractItem(settings: Settings) : Item(settings) {
    ...
    override fun use(world: World, user: PlayerEntity, hand: Hand): TypedActionResult<ItemStack> {
        ...
        val signedContract: ItemStack = BindingItems.SIGNED_CONTRACT.defaultStack
        signedContract.nbt = nbt
